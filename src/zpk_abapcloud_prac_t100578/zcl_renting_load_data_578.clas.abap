CLASS zcl_renting_load_data_578 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_578 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    "****************************************
    DATA: lt_brands TYPE TABLE OF zrent_brands_578,
    lt_cars TYPE TABLE OF zrent_cars_578,
    lt_customers TYPE TABLE OF zrent_custom_578.
...
*    * BRANDS **
    ...
    DELETE FROM zrent_brands_578.
    INSERT zrent_brands_578 FROM TABLE @lt_brands.
    SELECT * FROM zrent_brands_578 INTO TABLE @lt_brands.
    out->write( sy-dbcnt ).
...
*    * CARS**
    ...
    DELETE FROM zrent_cars_578.
    INSERT zrent_cars_578 FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_578 INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).
...
*    * CUSTOMERS**
    ...
    DELETE FROM zrent_custom_578.
    INSERT zrent_custom_578 FROM TABLE @lt_customers.
    SELECT * FROM zrent_custom_578 INTO TABLE @lt_customers.
    out->write( sy-dbcnt ).
